    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookmarked_by', models.ManyToManyField(blank=True, related_name='bookmarked_posts', to=settings.AUTH_USER_MODEL, verbose_name='Bookmarked by')),
                ('downvoted_by', models.ManyToManyField(blank=True, related_name='downvoted_posts', to=settings.AUTH_USER_MODEL, verbose_name='Downvoted by')),
                ('tags', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
                ('upvoted_by', models.ManyToManyField(blank=True, related_name='upvoted_posts', to=settings.AUTH_USER_MODEL, verbose_name='Upvoted by')),
            ],
            options={
                'verbose_name': 'Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='posts.post', verbose_name='Post')),
            ],
            options={
                'verbose_name': 'Reply',
