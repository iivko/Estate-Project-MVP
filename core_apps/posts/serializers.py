...
class TopPostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ["id", "title", "slug", "author_username", "upvotes", "view_count", "replies_count", "avatar", "created_at"]
...
class ReplySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Reply
        fields = ["id", "post", "author_username", "body", "avatar", "created_at", "updated_at"]
...
class BasePostSerializer(serializers.ModelSerializer):
    ...
    def get_created_at(self, obj):
        time_now = obj.created_at
        formatted_date = time_now.strftime("%d.%m.%Y %H:%M:%S")

        return formatted_date


    def get_updated_at(self, obj):
        time_then = obj.updated_at
        formatted_date = time_then.strftime("%d.%m.%Y %H:%M:%S")
