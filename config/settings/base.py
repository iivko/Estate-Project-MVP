...
# Argon2 Password Hashers. Argon2 is the winner of the 2015 Password Hashing Competition.
PASSWORD_HASHERS = [
...
CELERY_TASK_TIME_LIMIT = 5 * 60 # 5min
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(days=int(getenv("REFRESH_TOKEN_LIFETIME", "1"))),
