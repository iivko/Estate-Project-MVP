...
schema_view = get_schema_view(
    openapi.Info(
        ...
        contact=openapi.Contact(email="iiivkoo11@gmail.com"),
...
urlpatterns = [
    # Path to the OpenAPI documentation
...
admin.site.site_title = settings.SITE_NAME + " Admin Portal"
admin.site.index_title = "Welcome to " + settings.SITE_NAME + " Admin Portal"